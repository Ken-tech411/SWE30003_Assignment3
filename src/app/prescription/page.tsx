    ...
    return (
      <>
        ...
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-8">Staff Prescription Management</h1>
          {/* Staff-specific prescription content goes here */}
        </div>
      </>
    );
  }
  ...
  if (user.role === "customer") {
    return (
      <>
        ...
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-8">Upload Your Prescription</h1>
